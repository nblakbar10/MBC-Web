...
export default function Dashboard(props: Props) {
	...
	return (
		<DashboardAdminLayout
			title="Dashboard"
		>
            <div className="max-w-7xl mx-auto sm:px-6 md:px-6 lg:px-3 xl:px-6 mt-10 ">
                ...
                <div className="max-w-7xl mx-auto sm:px-6 md:px-6 lg:px-6 py-2 ">
                    <div className="bg-white shadow-sm shadow-neutral-700 overflow-hidden sm:rounded-lg p-4">
                ...
                <div className="max-w-7xl mx-auto sm:px-6 md:px-6 lg:px-6 xl:px-6 py-2 ">
                    <div className="bg-white shadow-sm shadow-neutral-700 overflow-hidden sm:rounded-lg p-4">
                    </div>
                </div>
                <div className="max-w-7xl mx-auto sm:px-6 md:px-6 lg:px-6 xl:px-6 py-2 ">

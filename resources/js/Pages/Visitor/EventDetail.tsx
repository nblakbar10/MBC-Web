...
export default function Home({ event }: Props) {
    ...
    const handleSelectPromo = (newValue: TicketTypeModel) => {
    ...
    return (
        <AppLayout>
                        ...
                        <div className="flex flex-col gap-3 p-auto basis-1/2 p-3 md:p-10 rounded-2xl border-stone-600 border-2">
                            ...
                            <div className="text-md md:text-xl mt-10 flex flex-col gap-3">
                                ...
                                <p className="flex gap-2 p-2">
                                    ...
                                    {new Date(event.start_date).toLocaleDateString("id") + '-' + new Date(event.start_date).toLocaleTimeString("id") }
                                </p>
                                <p className="flex gap-2 p-2">
                                    ...
                                    {new Date(event.end_date).toLocaleDateString("id") + '-' + new Date(event.end_date).toLocaleTimeString("id")}
                                </p>
                            </div>
                                        ...
                                        event.ticket_types.map((ticketType) => (
                                            <div className="p-4 border-stone-600 border-2 flex flex-col gap-2">
                                                ...
                                                <div className="border-gray-500 border-dashed border-t-2 text-md md:text-xl mt-5 flex justify-between py-3">
                                                    ...
                                                    {ticketType.stock > 0 ? (
                                                        <button className="bg-[#2EA1DA] hover:bg-blue-500 text-xl text-white font-bold py-1 px-7 rounded-lg" onClick={() => handleSelectPromo(ticketType)}>
                                                            Beli Tiket
                                                        </button>
                                                    ) : (
            ...
            <BuyDialogForm
                ...
                discounts={
                    selectedTicketType && selectedTicketType.ticket_discounts && selectedTicketType.ticket_discounts.length > 0

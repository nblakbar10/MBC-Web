                      ...
                      <td valign="top" style="width: 80% padding-top: 10px; margin-right: 0.75rem; border: solid;">
                        <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                          <tr>
                            ...
                            <td class="text-md">:</td>
                            <td class="text-services" style="text-align: left; ">ikram</td>
                          </tr>
                          <tr>
                            <td class="text-services" style="text-align: left; ">No.HP</td>
                            <td class="text-md">:</td>
                            <td class="text-services" style="text-align: left; ">081111111111</td>
                          </tr>
                          <tr>
                            <td class="text-services" style="text-align: left; ">Email</td>
                            <td class="text-md">:</td>
                            <td class="text-services" style="text-align: left; ">sitikholifatulmarifah@gmail.com</td>
                          </tr>
                          <tr>
                            <td class="text-services" style="text-align: left; ">Jumlah Tiket</td>
                            <td class="text-md">:</td>
                            <td class="text-services" style="text-align: left; ">1</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="text-md">:</td>
                            <td class="text-services" style="text-align: left; ">207000</td>
                          </tr>
                          <tr>
